...
@Component({
  selector: 'app-pricing-custom',
  templateUrl: './pricing-custom.component.html',
  styleUrls: ['./pricing-custom.component.css']
})
export class PricingCustomComponent implements OnInit {
